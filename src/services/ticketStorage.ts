...
const normalizeApplication = (application: Partial<TicketApplication>): TicketApplication => {
  ...
  return {
    ...
    latitude: typeof application.latitude === "number" ? application.latitude : undefined,
    longitude: typeof application.longitude === "number" ? application.longitude : undefined,
